...
void CashRegister :: add_taxable_item(double price){
    ...
    salesCount = salesCount + 1;
    salesTotal = salesTotal + taxedPrice;
...
int CashRegister::get_sales_count() const{
    cout << endl << "Today's sales count: ";
    return salesCount; 
}

// gets sales total
double CashRegister::get_sales_total() const{
    cout << endl << "Today's sales total: $";
    return salesTotal;
}

// resets sales total and sales count.
void CashRegister::reset_sales(){
    salesTotal = 0.0;
    salesCount = 0;
    cout << endl << "Today's sales are reset." << endl;
};